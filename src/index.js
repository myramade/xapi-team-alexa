...
module.exports.handler = (event, context, callback) => {
  ...
  alexa.applicationId = "amzn1.ask.skill.f5788d35-59c1-484b-ae2f-09e85f08a372";
...
const handlers = {
  ...
  'Go': function() {
    ...
    followLink(this.event, [slotValues['yesno']['resolved'], slotValues['yesno']['synonym']]);
    this.emit('WhereAmI');
  },
  'Page': function() {
...
var stmt = {
            "actor": {
                "mbox": "mailto:bryan.wanzer@gmail.com",
                "objectType": "Agent"
            },
            "verb": {
        ...
        var conf = {
            "url" : "https://xapiproject.waxlrs.com/TCAPI/",
            "auth" : {
                user : "OY3UZn91vtxQCAx2UmrK",
                pass : "BFCM7QAeXl9gaLVAvWgP"
            }
        };
